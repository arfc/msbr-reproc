...
online reprocessing strategy. Figure~\ref{fig:keff_zoomed} shows how different 
reprocessing groups imposed on effective multiplication factor.
...
\begin{figure}[ht!] 
  ...
  \caption{Effective multiplication factor for 150-EFPD time-frame.}

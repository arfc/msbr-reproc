...
<<<<<<< HEAD
distribution for $^{232}$Th normalized by the total neutron flux for initial and 
equilibrium states. The distribution reflects the spatial distribution of 
=======
...
$1.3778\pm.00005$ \\ 
Thermal utilization factor (f)           & $0.9670\pm.000011$     & 
$0.9706\pm.00001$ \\
...
because allows achieve longer core lifetime.
>>>>>>> 435d2d550cc97aafcbb0d28d2b1c025ebc90eaff
\begin{figure}[ht!] % replace 't' with 'b' to force it to 
  \centering

...
\begin{questions}
        ...
        \begin{solution}
                In the Table 5 added information that reference column contains data for initial 					fuel salt composition. Details about uncertainties has been added:
                
                Uncertainty for each temperature coefficient was obtain by propagating 			  				statistical error for effective multiplication factor calculation (confidence
                 interval $\pm$1.9 pcm) provided by SERPENT2 and also appears in Table 5.
        \end{solution}

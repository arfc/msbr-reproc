...
ChemTriton/SCALE packages, and could be employed for simulating immediate removal of 
...
Lastly, this work enables accident safety analysis such as multi-physics 
simulation of the \gls{MSBR} with the coupled 
